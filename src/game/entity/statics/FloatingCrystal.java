...
public class FloatingCrystal extends StaticEntity {

	private Animation animationFloating;

	public FloatingCrystal(GameThread gameThread, float xPos, float yPos, int width, int height) {
		...
		animationFloating = new Animation(700, Assets.floating_crystal);
	}
